...
public class resize_to_cut_customAdapter extends RecyclerView.Adapter<resize_to_cut_customAdapter.MyViewHolder> {
    private Context context;
    private ArrayList oid,cn,tamt,dd,s,en;

    resize_to_cut_customAdapter(Context context,ArrayList oid,ArrayList cn,ArrayList tamt,ArrayList dd,ArrayList s,ArrayList en){
