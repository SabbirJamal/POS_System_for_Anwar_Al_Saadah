...
public class viewResizeDetails extends RecyclerView.Adapter<viewResizeDetails.MyViewHolder> {
    Context context;
    private ArrayList h,wc,wh,s,b,hand,a,w;

    viewResizeDetails(Context context,ArrayList h,ArrayList wc,ArrayList wh,ArrayList s,ArrayList b,ArrayList hand,ArrayList a,ArrayList w){
