...
public class customAdapter_CardViewStitch_View extends RecyclerView.Adapter<customAdapter_CardViewStitch_View.MyViewHolder> {
    private Context context;
    private ArrayList oid,cn,tamt,dd,s,en;

    customAdapter_CardViewStitch_View(Context context,ArrayList oid,ArrayList cn,ArrayList tamt,ArrayList dd,ArrayList s,ArrayList en){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.resize_to_cut,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context,updateTailorResize.class);
