...
public class customAdapter_orderProcess extends RecyclerView.Adapter<customAdapter_orderProcess.MyViewHolder> {
    private Context context;
    private ArrayList phone,cd,ct,h,wc,wh,s,b,hand,a,w,ai;

    customAdapter_orderProcess(Context context,ArrayList phone,ArrayList cd,ArrayList ct,ArrayList h,ArrayList wc,ArrayList wh,ArrayList s,ArrayList b,ArrayList hand,ArrayList a,ArrayList w,ArrayList ai){
