...
public class customAdapter_orderANDresizeCardview extends RecyclerView.Adapter<customAdapter_orderANDresizeCardview.MyViewHolder> {
    private Context context;
    private ArrayList oid,cn,tamt,dd,s,en;

    customAdapter_orderANDresizeCardview(Context context,ArrayList oid,ArrayList cn,ArrayList tamt,ArrayList dd,ArrayList s,ArrayList en){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context,onlyViewOrder.class);
