...
public class customAdapter_orderStitchProcess extends RecyclerView.Adapter<customAdapter_orderStitchProcess.MyViewHolder> {
    private Context context;
    private ArrayList phone,cd,ct,h,wc,wh,s,b,hand,a,w,ai;

    customAdapter_orderStitchProcess(Context context,ArrayList phone,ArrayList cd,ArrayList ct,ArrayList h,ArrayList wc,ArrayList wh,ArrayList s,ArrayList b,ArrayList hand,ArrayList a,ArrayList w,ArrayList ai){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.updateorderprocessextra,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        holder.txtphone.setText(String.valueOf(phone.get(position)));
        holder.txtcd.setText(String.valueOf(cd.get(position)));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        TextView txtphone,txtcd,txtct,txth,txtwc,txtwh,txts,txtb,txthand,txta,txtw,txtai;
        CardView cv;
        public MyViewHolder(@NonNull View itemView){
            super (itemView);
            txtphone=itemView.findViewById(R.id.phn);
            txtcd=itemView.findViewById(R.id.cldesign);
            txtct=itemView.findViewById(R.id.cltype);
            ...
            txtai=itemView.findViewById(R.id.additionalinfo);
